//===-- MiniATAnalyzeImmediate.cpp - Analyze Immediates ---------------------===//
//
...
MiniATAnalyzeImmediate::Inst::Inst(unsigned O, unsigned I) : Opc(O), ImmOpnd(I) {}

// Add I to the instruction sequences.
void MiniATAnalyzeImmediate::AddInstr(InstSeqLs &SeqLs, const Inst &I) {
...
void MiniATAnalyzeImmediate::GetShortestSeq(InstSeqLs &SeqLs, InstSeq &Insts) {
